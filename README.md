...
```go
import "github.com/example/go-multi-major-modules/rate-limit/v1"
// or
import "github.com/example/go-multi-major-modules/rate-limit/v2"
// or
import "github.com/example/go-multi-major-modules/add-header/v3"
```
